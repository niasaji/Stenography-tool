...
class Stegno:
    ...
    def frame2_decode(self,d_f2):
        ...
        if not myfile:
            ...
            back_button.config(font=('bebas neue',11))
            back_button.grid(pady=15)
            back_button.grid()
            show_info = Button(d_f3,text='More Info',command=self.info)
            show_info.config(font=('bebas neue',11))
            show_info.grid()
            d_f3.grid(row=1)
            d_f2.destroy()
    ...
    def frame2_encode(self,f2):
        ...
        if not myfile:
            ...
            encode_button.config(font=('bebas neue',11))
